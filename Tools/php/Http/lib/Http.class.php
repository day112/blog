...
class Http
{
  ...
  private $httpParams = null;
     ...
     * @return $this
     */
    public function setUserAgent($agent = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/57.0.2987.98 Safari/537.36")
    {
        if ($agent) {
            // 模拟用户使用的浏览器
     ...
     * @return $this
     */
    public function showResponseHeader($show = 1)
    {
